...
<div class="jumbotron hh">
	<div class="row">
		...
		<h5 class="text-center text-success"><b>PLEASE SUBMIT YOUR FEEDBACK</b></h5>
		<form class="form-group" action="feedback_code.php" method="post">
			<lavel class="text-white">NAME</lavel>
                      <div class="input-group-append">
							<span class="input-group-text"style="background: cyan"><i class="fas fa-user"></i></span>
			<input type="text" name="name" placeholder="ENTER YOUR NAME" required class="form-control"/></div>
			<lavel class="text-white">MOBILE</lavel>
                   <div class="input-group-append">
							<span class="input-group-text"style="background: cyan"><i class="fas fa-phone"></i></span>
			<input type="number" name="mobile" required placeholder="ENTER YOUR MOBILE NUMBER" class="form-control"/></div>
			...
			<lavel class="text-white">WRITE YOUR FEEDBACK</lavel>
                   <div class="input-group-append">
							<span class="input-group-text"style="background: cyan"><i class="fas fa-envelope"></i></span>
			<textarea rows=2 required name="feedback" placeholder="WRITE YOUR FEEDBACK HERE" class="form-control"/></textarea></div><BR>
			<center><button class="btn-success" style="width:150px;height:40px;border-radius:10px;">SUBMIT</button></center>
