      ...
      <div class="row">
        ...
        <!-- feedback section start -->
  		<div class="col-md-10 mt-4">
            <div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>MANAGE ALL USERS </b></div><br>
    ...
    while($k=mysqli_fetch_array($r,MYSQLI_BOTH))
{
 	?>
       	<tr bgcolor="pink" align=center>
       		...
       		<td><?php echo $k['2']?> </td>
       		<td><?php echo $k['3']?></td>
          <td><a href="userdel.php?id=<?php echo $k['0'];?>">DELETE</a></td>
