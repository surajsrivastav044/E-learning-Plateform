...
<!-- sidebar starts -->
  ...
  <!-- ========================================================================================================================== -->
        ...
        <div>
        <h3 class="text-center mt-4"><b>Manage Your <?php  echo $_GET['course_name'];  ?>  online video tutorial</b></h3>
        <button class="btn btn-primary ml-4" data-toggle="modal" data-target="#myModal">add new video</button><br>
      </div>
