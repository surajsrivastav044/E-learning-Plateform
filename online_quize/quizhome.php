...
<!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../index.php"><b>Cognito School</b></a>
    ...
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu text-white fade" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="../programmingdemo.php"><b>Programming Tutorials</b></a>
          <a class="dropdown-item" href="../video tutorials/java/display_video_courses.php"><b>Videos tutorials</b></a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#"><b>online quiz</b></a>
        </div>
      </li>
    </ul>
  </div>
