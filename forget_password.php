...
<div class="jumbotron hh">
	<div class="row">
		...
		<h5 class="text-center text-success"><b>FORGET PASSWORD</b></h5>
		<form class="form-group" action="forgetpassword_code.php" method="post">
			<lavel class="text-white">ENTER EMAIL:</lavel>
			...
			<lavel class="text-white ">ENTER NEW PASSWORD</lavel>
            
            <div class="input-group-append ">
			<span class="input-group-text"style="background: cyan"><i class="fas fa-envelope"></i></span>
			<input type="password" required name="new_password" placeholder="ENTER YOUR NEW PASSWORD" class="form-control"/></textarea></div>
			<lavel class="text-white">ENTER CONFIRM PASSWORD</lavel>
                   <div class="input-group-append">
							<span class="input-group-text"style="background: cyan"><i class="fas fa-envelope"></i></span>
			<input type="password" required name="con_password" placeholder="ENTER YOUR CONFIRM PASSWORD" class="form-control"/></textarea></div><BR>
            <center><button class="btn-success mt-2" style="width:150px;height:40px;border-radius:10px;">SUBMIT</button></center>			
        </form>
		</div>
		<div class="col-sm-4"></div>
	</div>
