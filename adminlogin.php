...
<div class="jumbotron hh">
	<div class="row">
		...
		<h5 class="text-center text-success"><b>ADMIN LOGIN</b></h5>
		<form class="form-group" action="adminlogin_code.php" method="post">
			...
			<lavel class="text-white">PASSWORD</lavel>
                   <div class="input-group-append">
							<span class="input-group-text"style="background: cyan"><i class="fas fa-envelope"></i></span>
			<input type="text" required name="password" placeholder="WRITE YOUR PASSWORD" class="form-control"/></textarea></div><BR>
