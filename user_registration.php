...
<div class="jumbotron hh">
	<div class="row">
		...
		<h5 class="text-center text-success"><b>USER REGISTRATION</b></h5>
		<form class="form-group" action="registration_code.php" method="post">
			...
			<lavel class="text-white">PASSWORD</level>
                   <div class="input-group-append">
							<span class="input-group-text" style="background: cyan"><i class="fas fa-envelope"></i></span>
			<input type="password" required name="password" placeholder="ENTER YOUR PASSWORD" class="form-control"/></textarea></div><BR>
			<center><button class="btn-success" style="width:150px;height:40px;border-radius:10px;">REGISTER</button></center>
